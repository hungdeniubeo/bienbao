...
path = r"G:\Bienbao\Dataset\Train"
labelFile = r"G:\Bienbao\Dataset\Train.csv"
base_dir = r"G:\Bienbao\Dataset"
...
df_test = pd.read_csv(r'G:\Bienbao\Dataset\Test.csv')

Y_test = df_test['ClassId'].values
print(Y_test)

test_images = df_test["Path"].values  # Cột 'Path' chứa tên file ảnh (ví dụ: 'Test/00000.png')
data_test = []

for img in test_images:
    img_path = os.path.join(base_dir, img)  # Ghép đường dẫn tuyệt đối
